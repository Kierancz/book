...
// DATA
//
var firebaseRef = new Firebase('https://kieran-book.firebaseio.com')
...
actions.deleteMessage = function(chatEntry){
  var charRef = firebaseRef.child("chatrooms/" + data.chatroom.name + "/chats/" + chatEntry.id)
  chatRef.remove();
  render();
}
